...
def create_data(dataset_path):
    ...
    try:
        df = pd.read_csv(dataset_path+"/kin8nm.data", header=None, sep=',')
    except FileNotFoundError:
        df = pd.read_csv("C:/Users/FlorianBley/PycharmProjects/MC_dropout_explaining/data/kin8nm/kin8nm.data", header=None, sep=',')

    df_X, df_y = df.iloc[:, :8], df.iloc[:, 8:9]
